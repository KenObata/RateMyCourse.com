...
class MathView(ListView):
    ...
    def get_queryset(self):
        ...
        return Post.objects.filter(course_category='math').order_by('-published_date')

class StatView(ListView):
    model = Post
    def get_queryset(self):
        
        return Post.objects.filter(course_category='stat').order_by('-published_date')

class CSCView(ListView):
    model = Post
    def get_queryset(self):
        
        return Post.objects.filter(course_category='csc').order_by('-published_date')

class SENGView(ListView):
    model = Post
    def get_queryset(self):
        
        return Post.objects.filter(course_category='seng').order_by('-published_date')
